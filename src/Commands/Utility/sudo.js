module.exports = {
    ...
    run: async (client, message, args) => {
       if(!message.guild.me.permissions.has("MANAGE_WEBHOOKS")) return message.channel.send('I dont have the required permission, `MANAGE_WEBHOOKS`, webhooks created are deleted after so you dont have to worry about raids')
      let user =
